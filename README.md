...
```
root@otus-bilder-app:/home/vagrant# systemctl status spawn-fcgi.service
...
```
```
root@otus-bilder-app:/etc/apache2-test# ss -tnulp | grep apache2
...
root@otus-bilder-app:/etc/apache2-test# systemctl status apache2@test.service
...
Jun 04 18:41:16 otus-bilder-app systemd[1]: Starting The Apache HTTP Server...
Jun 04 18:41:16 otus-bilder-app apachectl[36807]: AH00558: apache2: Could not reliably determine the server's fully qualified domain name, using 127.0.2.1.>
Jun 04 18:41:16 otus-bilder-app systemd[1]: Started The Apache HTTP Server.
root@otus-bilder-app:/etc/apache2-test# systemctl stop apache2@test.service
root@otus-bilder-app:/etc/apache2-test# ss -tnulp | grep apache2
tcp    LISTEN  0        511                 0.0.0.0:80            0.0.0.0:*      users:(("apache2",pid=17573,fd=3),("apache2",pid=17572,fd=3),("apache2",pid=17571,fd=3),("apache2",pid=17570,fd=3),("apache2",pid=17569,fd=3),("apache2",pid=17548,fd=3))
root@otus-bilder-app:/etc/apache2-test# 
```